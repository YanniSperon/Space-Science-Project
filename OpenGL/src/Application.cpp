...
int main(void)
{
...

	{
		...
		GLuint grassTex = Loader::loadSpriteSheet("res/images/sprites/", "grass.png", GL_REPEAT, GL_REPEAT, GL_NEAREST_MIPMAP_NEAREST, GL_NEAREST);
		GLuint mainMenuTex = Loader::loadSpriteSheet("res/images/backgrounds/", "MainMenue.png", GL_REPEAT, GL_REPEAT, GL_NEAREST_MIPMAP_NEAREST, GL_NEAREST);
		GLuint endMenuTex = Loader::loadSpriteSheet("res/images/backgrounds/", "End.png", GL_REPEAT, GL_REPEAT, GL_NEAREST_MIPMAP_NEAREST, GL_NEAREST);
		/////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		while (!glfwWindowShouldClose(window) && !quitGame)
		{
			...
			if (!tabPressed) {
				...
				if (actNumber == -1) {
					...
					renderer.submitForceRender(&mainMenuBackground);
					///////////////////////////////////////////////////////////////////////////
				...
				if (actNumber == 4) {
					...
					///////////////////////////////////////////////////////////////////////////
					camera.Follow(dino);
					camera.BringWith(chrisBackground);
					glm::vec3 camPos = camera.GetTranslation();
					///////////////////////////////////////////////////////////////////////////
					glm::mat4 viewMatrix = camera.GetViewTransformMatrix();
					glm::mat4 projectionMatrix;
					...
					///////////////////////////////////////////////////////////////////////////
					renderer.submitForceRender(&chrisBackground);
					///////////////////////////////////////////////////////////////////////////
